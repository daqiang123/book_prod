...
CREATE TABLE `sys_role_user` (
  `role_user_id` varchar(32) NOT NULL COMMENT '角色用户主键',
  `role_id` varchar(32) DEFAULT NULL COMMENT '角色主键',
  `id` varchar(32) DEFAULT NULL COMMENT '用户主键',
  PRIMARY KEY (`role_user_id`),
  KEY `FK_Reference_1` (`role_id`),
  KEY `FK_Reference_2` (`id`),
  CONSTRAINT `FK_Reference_1` FOREIGN KEY (`role_id`) REFERENCES `sys_role` (`role_id`),
  CONSTRAINT `FK_Reference_2` FOREIGN KEY (`id`) REFERENCES `sys_user` (`id`)
...
-- Dump completed on 2019-04-04 16:52:55
