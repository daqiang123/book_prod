...
CREATE TABLE `sys_role` (
  ...
  `role_state` tinyint(1) DEFAULT NULL COMMENT '角色状态',
  `role_remark` varchar(100) DEFAULT NULL COMMENT '角色备注',
  PRIMARY KEY (`role_id`)
...
INSERT INTO `sys_role` VALUES ('1','管理员','ROLE_ADMIN','2','管理员角色',1,1,NULL),('2','用户','ROLE_USER','2','用户角色',2,1,NULL);
...
-- Dump completed on 2019-04-04 16:53:01
