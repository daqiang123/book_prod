...
CREATE TABLE `sys_button` (
  ...
  `button_code` varchar(100) DEFAULT NULL COMMENT '按钮编码',
  `button_type` varchar(32) DEFAULT NULL COMMENT '按钮类型',
  `button_sort` int(11) DEFAULT NULL COMMENT '按钮排序',
  `button_state` tinyint(1) DEFAULT NULL COMMENT '按钮状态',
  `button_remark` varchar(100) DEFAULT NULL COMMENT '按钮备注',
  PRIMARY KEY (`button_id`),
  KEY `FK_Reference_49` (`menu_id`),
  CONSTRAINT `FK_Reference_49` FOREIGN KEY (`menu_id`) REFERENCES `sys_menu` (`menu_id`)
...
-- Dump completed on 2019-04-04 16:52:57
